            ...
            <div class="carousel-inner">
                <div class="item active">
                    <div class="testimony-person animated fadeIn">
                        <img class="img-responsive" src="<?php echo base_url() ?>assets/images/testimonial/man1.png" alt="" />  
                    </div>
                ...
                <div class="item">
                    <div class="testimony-person animated fadeIn">
                        <img class="img-responsive" src="<?php echo base_url() ?>assets/images/testimonial/man2.png" alt="" />      
                    </div>
                    <div class="testimony-caption default-bg">
                        <div class="testimonial animated rubberBand">
                ...
                <div class="item">
                    <div class="testimony-person animated fadeIn">
                        <img class="img-responsive" src="<?php echo base_url() ?>assets/images/testimonial/man3.png" alt="" />  
                    </div>
                    <div class="testimony-caption default-bg">
                        <div class="testimonial animated rubberBand">
                            <h3>Mark Derain</h3>
        ...
        <div class="container">
            ...
            <div id="clients-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner wow flipInX" data-wow-duration="1200ms" data-wow-delay="500ms">
                    <div class="item active">                       
                        <ul>
                            <li><a class="img-responsive" href="#"><img src="<?php echo base_url() ?>assets/images/client/indosat.png" alt="" /></a></li>
                            <li><a class="img-responsive" href="#"><img src="<?php echo base_url() ?>assets/images/client/xl.png" alt="" /></a></li>
                            <li><a class="img-responsive" href="#"><img src="<?php echo base_url() ?>assets/images/client/harapanbunda.png" alt="" /></a></li>
