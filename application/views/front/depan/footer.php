    <footer id="footer">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-8">
                        <div class="wow fadeInUp" data-wow-duration="1200ms" data-wow-delay="500ms">
                            ...
                            <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="https://www.themeregion.com/demo/butex2.0/sendemail.php">
        ...
        <div class="bottom default-bg text-center wow fadeIn" data-wow-duration="1500ms" data-wow-delay="300ms">
            <div class="container  text-center">
                <p>copyright &copy; 2017 butex theme. All Rights Reserved.<br> Designed by <a href="http://www.themeregion.com/">ThemeRegion</a></p>                
            </div>
        </div>  
    </footer><!--/#footer--> 